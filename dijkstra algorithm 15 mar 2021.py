...
# Difference between set and list, a set has no order.
# A set is immutable meaning it cannot be changed once it has been set.
# (The keys to a dictionary must be immutable)
...
while priority_queue:
    ...
    # for each neighbour of 'next_node', check if it is necessary to update the distance to that neighbour.
